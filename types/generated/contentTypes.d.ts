...
export interface ApiArtworkArtwork extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    conservation: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiImageImage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    crops: Schema.Attribute.Relation<'oneToMany', 'api::crop.crop'>;
    description: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiMuseumMuseum extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    actualname: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    images: Schema.Attribute.Relation<'oneToMany', 'api::image.image'>;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::museum.museum'>;
    model3d: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiVilleVille extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    museums: Schema.Attribute.Relation<'oneToMany', 'api::museum.museum'>;
    name: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
